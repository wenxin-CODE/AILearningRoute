...
if __name__ == '__main__':
    ...
    # 4.3
    data_path = r'F:\AI路线书籍\MachineLearning_Zhouzhihua_ProblemSets-master\data\watermelon3_0_Ch.csv'
    ...
    # # 4.4
    # data_path2 = r'F:\AI路线书籍\MachineLearning_Zhouzhihua_ProblemSets-master\data\watermelon2_0_Ch.txt'
